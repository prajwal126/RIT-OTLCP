...
public class PhyFrag  extends android.support.v4.app.Fragment{
    private ImageView img;
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view= inflater.inflate(R.layout.frag_phy,null);
        img = (ImageView) view.findViewById(R.id.imageView11);
        img.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(getActivity(), coursereg.class);
                myIntent.putExtra("ID","physics");
                PhyFrag.this.startActivity(myIntent);
            }
        });
        return view;
